document.addEventListener('DOMContentLoaded', () => {
    ...
    const analyzeQuizAnswers = () => {
        ...
        // Семейный статус (вопрос 6, индекс 5)
        ...
        // Расходы на интимные товары (вопрос 7, индекс 6)
        const spendingIndex = answers[6];
        const spendingLevels = ["never_bought", "under_20", "20_to_50", "50_to_100", "over_100"];
        state.purchaseFrequency = spendingLevels[spendingIndex] || "unknown";
        
        // Профиль предпочтений на основе первых вопросов
    ...
    const renderQuiz = () => {
        ...
        const showBackButton = state.currentQuestionIndex > 0;
        ...
        sections.quiz.innerHTML = `
            <div class="w-full max-w-2xl mx-auto text-center">
                ...
                ${showBackButton ? `
                    <div class="mt-8">
                        <button id="quiz-back-btn" class="bg-gray-600 hover:bg-gray-500 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300">
                            <i data-lucide="chevron-left" class="w-5 h-5 inline-block mr-2"></i>
                            Indietro
                        </button>
                    </div>
                ` : ''}
        ...
        const backButton = document.getElementById('quiz-back-btn');
        if (backButton) {
